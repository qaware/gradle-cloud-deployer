...
/**
 * Represents a kubernetes ping resource.
 */
public class KubernetesPingResource extends BasePingResource {

    /**
     * The client used for backend communication.
     */
    private final KubernetesPingClient kubernetesPingClient;
    ...
    public KubernetesPingResource(EnvironmentConfig environmentConfig) throws ResourceException {
        ...
        kubernetesPingClient = clientFactory.create(KubernetesPingClient.class);
    }

    @Override
    public void ping() throws ResourceException {
        Call<ResponseBody> call = kubernetesPingClient.ping();

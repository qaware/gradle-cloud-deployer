 ...
 * @author sjahreis
 */
class TokenInitializerTestHelper {

    private TokenInitializerTestHelper() {
    }

    static void assertExceptionOnInitialize(TokenInitializer tokenInitializer, EnvironmentConfig environmentConfig, String message) {

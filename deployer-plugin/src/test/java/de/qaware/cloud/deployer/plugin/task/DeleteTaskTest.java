 ...
 * @author sjahreis
 */
public class DeleteTaskTest extends BaseAllTaskTestHelper {
    ...
    @Test
    public void testDelete() throws EnvironmentConfigException, ResourceException, ResourceConfigException {
        DeleteTask deleteTask = (DeleteTask) task;
        Environment environment = environments.get(0);
        deleteTask.setEnvironmentId(environment.getId());

        deleteTask.delete();

        verify(deleteTask, times(1)).setupEnvironments();
